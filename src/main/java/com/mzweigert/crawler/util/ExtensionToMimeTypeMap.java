/*
 * Copyright put(c) 2019. BEST S.A. and/or its affiliates. All rights reserved.
 */
...
class ExtensionToMimeTypeMap {

    private ExtensionToMimeTypeMap() {
    }

    private static final Map<String, String> extensionsToMimeTypes = new HashMap<String, String>() {{
        put("323", "text/h323");
        put("3g2", "video/3gpp2");
        put("3gp", "video/3gpp");
        ...
        put("pst", "application/vnd.ms-outlook");
        ...
        put("rvt", "application/octet-stream");
        ...
        put("webm", "video/webm");
        put("webp", "image/webp"); /* https://en.wikipedia.org/wiki/WebP */
        ...
        put("xml", "text/xml");
        put("xmp", "application/octet-stream");
     ...
     * @return True iff there is an extension entry in the mapMany.
     */
